...
import { AlertCircle, Stethoscope, ArrowLeft, ArrowRight } from 'lucide-react';
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-indigo-50 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900 flex items-center justify-center p-4">
      ...
      <Card className="w-full max-w-md dark:bg-gray-800 dark:border-gray-700 shadow-xl">
        <CardHeader className="text-center">
          ...
          <CardTitle className="text-2xl dark:text-white">Provider Registration</CardTitle>
          <p className="text-gray-600 dark:text-gray-400 text-sm mt-2">
            {step === 1 ? 'Step 1: Account Information' : 'Step 2: Professional Details'}
          </p>
          
          {/* Progress indicator */}
          <div className="flex justify-center mt-4 space-x-2">
            <div className={`h-2 w-16 rounded-full ${step >= 1 ? 'bg-blue-600' : 'bg-gray-300 dark:bg-gray-600'}`}></div>
            <div className={`h-2 w-16 rounded-full ${step >= 2 ? 'bg-blue-600' : 'bg-gray-300 dark:bg-gray-600'}`}></div>
          </div>
        </CardHeader>
        <CardContent>
              ...
              <>
                <div>
                  ...
                  <Input
                    id="specialty"
                    type="text"
                    placeholder="e.g., Clinical Psychologist, Family Medicine"
          ...
          <div className="mt-6 text-center text-sm">
            ...
            <Link to="/provider/login" className="text-blue-600 hover:text-blue-700 dark:text-blue-400 font-medium">
              Sign in
            </Link>
          </div>
